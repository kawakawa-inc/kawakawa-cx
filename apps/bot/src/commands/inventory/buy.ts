...
export const buy: Command = {
  ...
  helpInfo: {
    category: 'trading',
    details:
      'Without a counterparty: browse sell orders (supply).\nWith a counterparty: create an invoice to buy from them.',
    examples: ['buy RAT', 'buy RAT BEN', 'buy 20 RAT BEN', 'buy 20 RAT BEN alice'],
  },
