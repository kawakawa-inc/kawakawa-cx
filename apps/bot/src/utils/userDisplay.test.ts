...
describe('userDisplay', () => {
  describe('getDisplayName', () => {
    it('prefers fioUsername', () => {
      expect(
        getDisplayName({ username: 'john', displayName: 'John', fioUsername: 'JohnFIO' })
      ).toBe('JohnFIO')
    })

    it('falls back to displayName when no fioUsername', () => {
      expect(getDisplayName({ username: 'john', displayName: 'John Doe', fioUsername: null })).toBe(
        'John Doe'
      )
    })
    ...
    it('falls back to username when fioUsername is undefined', () => {
      expect(getDisplayName({ username: 'john', displayName: null, fioUsername: undefined })).toBe(
        'john'
      )
    })
  })
    ...
    it('prefers fioUsername', () => {
      expect(
        getOwnerDisplayName({
          ...
          ownerFioUsername: 'BobFIO',
          counterpartyUsername: 'x',
    ...
    it('prefers fioUsername', () => {
      expect(
        getCounterpartyDisplayName({
          ...
          counterpartyFioUsername: 'AliceFIO',
        })
      ).toBe('AliceFIO')
    })
    ...
    it('falls back to displayName', () => {
      expect(
        getCounterpartyDisplayName({
          ...
          ownerFioUsername: null,
          counterpartyUsername: 'alice',
          counterpartyDisplayName: 'Alice D',
          counterpartyFioUsername: null,
        })
      ).toBe('Alice D')
    })
