...
export class AdminDiscordService {
   ...
   * @throws ApiError
   */
  public static getGuildChannels(): CancelablePromise<
    Array<{
      name: string
      id: string
    }>
   ...
   * @throws ApiError
   */
  public static deleteRoleMapping({ id }: { id: number }): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/admin/discord/role-mappings/{id}',
      path: {
   ...
   * @throws ApiError
   */
  public static deleteChannelConfig({ channelId }: { channelId: string }): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/admin/discord/channel-config/{channelId}',
      path: {
