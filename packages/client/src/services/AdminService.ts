...
import type { KawaSheetSyncRequest } from '../models/KawaSheetSyncRequest';
...
import type { UpdateKawaSheetRequest } from '../models/UpdateKawaSheetRequest';
...
export class AdminService {
     ...
     * @throws ApiError
     */
    public static updateKawaSheetSettings({
        requestBody,
    }: {
        requestBody: UpdateKawaSheetRequest,
    }): CancelablePromise<PriceSettingsResponse> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/admin/price-settings/kawa-sheet',
            body: requestBody,
            mediaType: 'application/json',
        });
    }
     ...
     * @throws ApiError
     */
    public static previewKawaSheet(): CancelablePromise<{
        rows: Array<Array<string>>;
        headers: Array<string>;
    }> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/price-settings/kawa-sheet/preview',
        });
    }
    /**
     ...
     * @throws ApiError
     */
    public static syncKawaSheet({
        requestBody,
    }: {
        requestBody: KawaSheetSyncRequest,
    }): CancelablePromise<CsvImportResult> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/admin/price-settings/kawa-sheet/sync',
            body: requestBody,
            mediaType: 'application/json',
        });
    }
     ...
     * @throws ApiError
     */
    public static disconnectUserDiscord({
        userId,
    }: {
        userId: number,
    }): CancelablePromise<{
