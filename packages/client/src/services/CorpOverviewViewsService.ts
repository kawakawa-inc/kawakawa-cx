...
export class CorpOverviewViewsService {
   ...
   * @throws ApiError
   */
  public static getById({ id }: { id: number }): CancelablePromise<CorpOverviewView> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static togglePin({ id }: { id: number }): CancelablePromise<CorpOverviewView> {
    return __request(OpenAPI, {
      method: 'PUT',
   ...
   * @throws ApiError
   */
  public static recordVisit({ id }: { id: number }): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'POST',
