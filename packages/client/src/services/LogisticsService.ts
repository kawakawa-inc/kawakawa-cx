...
export class LogisticsService {
   ...
   * @throws ApiError
   */
  public static getTrip({ id }: { id: number }): CancelablePromise<Trip> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static deleteTrip({ id }: { id: number }): CancelablePromise<{
    success: boolean
  }> {
    return __request(OpenAPI, {
      method: 'DELETE',
   ...
   * @throws ApiError
   */
  public static getShipment({ id }: { id: number }): CancelablePromise<Shipment> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static deleteShipment({ id }: { id: number }): CancelablePromise<{
    success: boolean
  }> {
    return __request(OpenAPI, {
      method: 'DELETE',
   ...
   * @throws ApiError
   */
  public static delete({ id }: { id: number }): CancelablePromise<{
    success: boolean
  }> {
    return __request(OpenAPI, {
      method: 'DELETE',
   ...
   * @throws ApiError
   */
  public static deleteFlow({ id }: { id: number }): CancelablePromise<{
    success: boolean
  }> {
    return __request(OpenAPI, {
      method: 'DELETE',
   ...
   * @throws ApiError
   */
  public static deleteClaim({ id }: { id: number }): CancelablePromise<{
    success: boolean
  }> {
    return __request(OpenAPI, {
      method: 'DELETE',
