// Logistics Flow Graph types: hub/planet flow edges, manual demand claims,
// shipments/trips, and the solved graph (nodes/edges) that powers the
// Logistics view. See docs/guides/logistics-plan.md.
